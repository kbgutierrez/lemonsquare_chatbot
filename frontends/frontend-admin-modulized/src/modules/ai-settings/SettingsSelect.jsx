...
const SettingsSelect = ({
  ...
  // If the current value is not in the predefined options, create a dynamic option for it
  // so the user can see the actual API value instead of "Select option"
      ...
      <div ref={containerRef} className="relative">
        ...
        >
          <span className="truncate text-white">
            {selectedOption?.label || value || "Select option"}
          </span>
