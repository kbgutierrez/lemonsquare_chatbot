      ...
      <div className="space-y-3">
        <div>
          ...
          <p className="mt-1 text-sm leading-relaxed text-[var(--text-secondary)]">
            Save and activate the current AI pipeline configuration.
          </p>
        </div>
        ...
        {/* ERROR */}
        {error && (
          <div className="inline-flex items-center gap-2 rounded-md border border-red-500/20 bg-red-500/10 px-3 py-2 text-sm font-medium text-red-600 dark:text-red-400">
