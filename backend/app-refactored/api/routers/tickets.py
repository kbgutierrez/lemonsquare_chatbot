...
def delete_ticket_from_ai(
    ...
    try:
        ingestion_service.qdrant.delete(
            ...
            points_selector=__import__('qdrant_client.http.models', fromlist=['Filter', 'FieldCondition', 'MatchValue']).Filter(
                must=[
                    __import__('qdrant_client.http.models', fromlist=['Filter', 'FieldCondition', 'MatchValue']).FieldCondition(
                        key="metadata.ticket_number",
                        match=__import__('qdrant_client.http.models', fromlist=['Filter', 'FieldCondition', 'MatchValue']).MatchValue(value=ticket_number),
                    )
                ]
            ),
        )
